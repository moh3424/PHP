...
//----
//Envoyer un cookie :
echo time(); // la fonction prédéfinie time() returne le timestamp de maintenent = nombre de secondes écoulées depuis le 01/01/1970 à 0h.

$un_an = 365*24*60*60;// 1 an  exprimé en secondes
$date_validite = time( + $un_an);// on calcule la date de validité du cookie à un an à partir de maintenent
...
//Il n'existe pas de fonction prédéfinie permettant de SUPPRIMER un cookie. On peut cependant le rendre invalide en lui mettant une date d'expiration à 0ou dépassée, ou encore mettre uniquement le nom de cookie dans setcoohie()
//------------
