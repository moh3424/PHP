...
$pdo = new PDO ('mysql:host=localhost;dbname=id6625036_dialogue', // driver mysql : serveur; nom de la PDD
                'id6625036_mohamed1',// pseudo de la BDD
                'mohamed1', // Mot de passe de la BDD
